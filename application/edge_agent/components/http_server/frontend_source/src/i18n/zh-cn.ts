...
export const zhCn: Dict = {
  ...
  fileNoFolderSelected: '未选择文件夹',
  fileUploadFolder: '上传文件夹',
  fileFolderSelectionSummary: '{name}，共 {count} 个文件，{size}',
  fileFolderUploadConfirm:
    '将文件夹 {name} 上传到 {path}？共 {count} 个文件（{size}），同名文件将被覆盖。',
  fileFolderUploading: '正在上传 {completed}/{total}：{path}',
  fileFolderUploadComplete: '文件夹上传完成',
  fileFolderUploadFailed: '文件夹上传在 {path} 失败，已完成 {completed}/{total}：{error}',
  fileFolderUploadInvalidPath: '文件夹中包含不支持的路径：{path}',
  fileFolderUploadEmpty: '所选文件夹不包含可上传文件',
  fileColName: '名称',
  fileColType: '类型',
  fileColSize: '大小',
  fileColActions: '操作',
