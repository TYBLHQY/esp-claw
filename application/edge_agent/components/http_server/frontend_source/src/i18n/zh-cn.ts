...
export const zhCn: Dict = {
  ...
  navFiles: '文件管理',
  navWebIm: '在线聊天',
  navMaintenance: '维护与升级',
  maintenanceDesc: '配置备份、恢复与固件 OTA 升级。',
  maintenanceConfig: '配置备份',
  maintenanceBackup: '下载配置备份',
  maintenanceRestore: '恢复配置',
  maintenanceBackupDone: '配置备份已下载。',
  maintenanceRestoreDone: '配置已恢复。',
  maintenanceOta: '固件 OTA',
  maintenanceOtaUrl: '固件 HTTPS 地址',
  maintenanceOtaStart: '开始 OTA',
  maintenanceOtaStarted: 'OTA 已开始，设备完成后会自动重启。',
