export const en = {
  ...
  navFiles: 'Files',
  navWebIm: 'Web Chat',
  navMaintenance: 'Maintenance & OTA',
  maintenanceDesc: 'Configuration backup, restore, and HTTPS firmware OTA.',
  maintenanceConfig: 'Configuration backup',
  maintenanceBackup: 'Download backup',
  maintenanceRestore: 'Restore config',
  maintenanceBackupDone: 'Configuration backup downloaded.',
  maintenanceRestoreDone: 'Configuration restored.',
  maintenanceOta: 'Firmware OTA',
  maintenanceOtaUrl: 'Firmware HTTPS URL',
  maintenanceOtaStart: 'Start OTA',
  maintenanceOtaStarted: 'OTA started; the device will restart when complete.',
