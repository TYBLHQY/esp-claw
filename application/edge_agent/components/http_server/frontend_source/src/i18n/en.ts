export const en = {
  ...
  llmBackendPlaceholder: 'openai_responses / openai_compatible / anthropic_compatible',
  llmBaseUrl: 'Base URL',
  ...
  llmReasoningEffortPlaceholder: 'none / low / medium / high / xhigh / max',
  ...
  fileNoFolderSelected: 'No folder selected',
  fileUploadFolder: 'Upload Folder',
  fileFolderSelectionSummary: '{name}, {count} files, {size}',
  fileFolderUploadConfirm:
    'Upload {name} to {path}? {count} files ({size}). Files with the same name will be overwritten.',
  fileFolderUploading: 'Uploading {completed}/{total}: {path}',
  fileFolderUploadComplete: 'Folder upload complete',
  fileFolderUploadFailed: 'Folder upload failed at {path}; completed {completed}/{total}: {error}',
  fileFolderUploadInvalidPath: 'The folder contains an unsupported path: {path}',
  fileFolderUploadEmpty: 'The selected folder contains no uploadable files',
  fileColName: 'Name',
  fileColType: 'Type',
  fileColSize: 'Size',
